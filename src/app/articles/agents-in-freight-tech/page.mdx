...
The same intuition applies to task design. If a probabilistic model has to act on a user's behalf at near perfect accuracy, it is more sane to hand it easy tasks that are reliably executed on accurately.
