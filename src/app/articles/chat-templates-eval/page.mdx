...
export const article = {
  ...
  description:
    'LLM chatbots are usually finetuned on datasets using chat templates. These templates convert chat conversations into a single string, ready for feeding to a text generation model. At prediction time, matching this format is standard, as deviations can hurt performance. This blog examines whether such degradations appear when measuring LLM performance in academic evaluation benchmarks.',
}
