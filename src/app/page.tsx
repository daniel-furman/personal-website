      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
              You’ve reached Daniel Furman’s website. I work as a data scientist at a startup that’s trying to change how freight works. I do this from San Francisco. <br></br>
